...
const NICHE_SEED_COPY = {
  dental_clinic: {
    en: {
      ...
      benefits: ['Pain-free treatments', 'Digital X-Ray technology', 'Same-day appointments', '10+ years experience'],
    },
    bm: {
      headline: 'Senyum Cantik Bermula Di Sini',
      sub: 'Rawatan pergigian profesional — selesa, pantas, dan berpatutan',
      benefits: ['Rawatan tanpa sakit', 'X-Ray digital', 'Temujanji hari sama', '10+ tahun pengalaman'],
    },
    zh: {
      headline: '从这里开始，拥有自信的笑容',
      sub: '专业牙科护理 — 舒适、快捷、实惠',
      benefits: ['无痛治疗', '数字X光技术', '当天预约', '10年以上经验'],
    },
  },
  clinic_gp: {
    en: {
      headline: 'Your Trusted Family Doctor',
      sub: 'Comprehensive healthcare for you and your family',
      benefits: ['Experienced GP doctor', 'Same-day appointments', 'Full medication coverage', 'Friendly & caring staff'],
    },
    bm: {
      headline: 'Doktor Keluarga Yang Anda Percayai',
      sub: 'Penjagaan kesihatan menyeluruh untuk anda dan keluarga',
      benefits: ['Doktor GP berpengalaman', 'Temujanji hari sama', 'Liputan ubatan penuh', 'Kakitangan mesra & prihatin'],
    },
    zh: {
      headline: '您信赖的家庭医生',
      sub: '为您和家人提供全面的医疗保健',
      benefits: ['经验丰富的全科医生', '当天预约', '全面用药覆盖', '亲切友善的员工'],
    },
  },
  clinic_aesthetic: {
    en: {
      headline: 'Glow Up. Feel Confident. Look Amazing.',
      sub: 'Premium aesthetic treatments tailored for your skin',
      benefits: ['Certified aesthetic doctors', 'FDA-approved treatments', 'Visible results fast', 'Personalised skin consultation'],
    },
    bm: {
      headline: 'Cantik, Yakin, dan Berseri.',
      sub: 'Rawatan estetik premium untuk kulit anda',
      benefits: ['Doktor estetik bertauliah', 'Rawatan diluluskan FDA', 'Keputusan nyata pantas', 'Konsultasi kulit peribadi'],
    },
    zh: {
      headline: '焕发光彩，自信满满。',
      sub: '为您量身定制的高级美容疗程',
      benefits: ['认证美容医生', 'FDA认可疗程', '快速见效', '个性化皮肤咨询'],
    },
  },
  aircond_service: {
    en: {
      headline: 'Keep Cool — Expert Aircond Service',
      sub: 'Fast, reliable air-conditioning repair, cleaning & installation',
      benefits: ['Same-day service available', 'All brands & models', 'Certified technicians', 'Transparent pricing'],
    },
    bm: {
      headline: 'Aircond Rosak? Kami Baiki Hari Ini!',
      sub: 'Servis, baik pulih & pasang aircond — pantas dan boleh dipercayai',
      benefits: ['Servis hari sama tersedia', 'Semua jenama & model', 'Juruteknik bertauliah', 'Harga telus'],
    },
    zh: {
      headline: '专业冷气服务，快速上门',
      sub: '冷气维修、清洗与安装 — 快捷可靠',
      benefits: ['当天上门服务', '所有品牌型号', '认证技术员', '透明定价'],
    },
  },
  bengkel_kereta: {
    en: {
      headline: 'Your Car Deserves the Best Care',
      sub: 'Professional car service, repair & maintenance you can trust',
      benefits: ['Experienced mechanics', 'All makes & models', 'Genuine spare parts', 'Free diagnostic check'],
    },
    bm: {
      headline: 'Kereta Anda, Jagaan Terbaik Kami',
      sub: 'Servis, baik pulih & penyelenggaraan kereta profesional',
      benefits: ['Mekanik berpengalaman', 'Semua jenis kereta', 'Alat ganti tulen', 'Pemeriksaan diagnostik percuma'],
    },
    zh: {
      headline: '专业汽车维修，信赖之选',
      sub: '汽车保养、维修与服务，专业可靠',
      benefits: ['经验丰富的技师', '各种品牌车型', '原装零件', '免费诊断检查'],
    },
  },
  katering_event: {
    en: {
      headline: 'Unforgettable Events Start With Great Food',
      sub: 'Premium catering for weddings, corporate events & celebrations',
      benefits: ['Custom menus available', 'Fresh, quality ingredients', 'Professional event setup', 'Handles 50–5000 pax'],
    },
    bm: {
      headline: 'Majlis Meriah, Hidangan Istimewa',
      sub: 'Katering premium untuk majlis perkahwinan, korporat & perayaan',
      benefits: ['Menu boleh disesuaikan', 'Bahan-bahan segar berkualiti', 'Persediaan majlis profesional', 'Boleh uruskan 50–5000 pax'],
    },
    zh: {
      headline: '精彩活动，从美食开始',
      sub: '婚宴、企业活动与庆典的高级餐饮服务',
      benefits: ['定制菜单', '新鲜优质食材', '专业活动布置', '可承接50至5000人'],
    },
  },
  restoran_cafe: {
    en: {
      headline: 'Where Every Bite Tells a Story',
      sub: 'Delicious food, warm ambiance, and memories worth making',
      benefits: ['Fresh ingredients daily', 'Dine-in & takeaway', 'Family-friendly space', 'Authentic flavours'],
    },
    bm: {
      headline: 'Setiap Suapan, Penuh Kenangan',
      sub: 'Makanan lazat, suasana mesra, dan kenangan indah untuk dikongsi',
      benefits: ['Bahan segar setiap hari', 'Makan dalam & bawa balik', 'Ruang mesra keluarga', 'Rasa autentik'],
    },
    zh: {
      headline: '每一口，都是故事',
      sub: '美味佳肴、温馨环境，留下美好回忆',
      benefits: ['每日新鲜食材', '堂食与外卖均可', '家庭友好空间', '地道风味'],
    },
  },
  saloon_barbershop: {
    en: {
      headline: 'Look Sharp. Feel Great.',
      sub: 'Expert cuts, styling & grooming for every look',
      benefits: ['Experienced stylists', 'All hair types welcome', 'Walk-ins accepted', 'Relaxing atmosphere'],
    },
    bm: {
      headline: 'Kemas, Bergaya, Yakin Diri.',
      sub: 'Gunting, styling & grooming pakar untuk setiap penampilan',
      benefits: ['Stylist berpengalaman', 'Semua jenis rambut', 'Boleh masuk tanpa temujanji', 'Suasana santai'],
    },
    zh: {
      headline: '型格造型，自信风采',
      sub: '专业剪发、造型与美容护理',
      benefits: ['经验丰富的造型师', '适合各种发型', '接受即兴到访', '轻松舒适的环境'],
    },
  },
  pusat_tuisyen: {
    en: {
      headline: 'Unlock Your Child\'s Full Potential',
      sub: 'Result-focused tuition with experienced, caring tutors',
      benefits: ['Experienced qualified tutors', 'Small class sizes', 'Exam-focused syllabus', 'Regular progress reports'],
    },
    bm: {
      headline: 'Tingkatkan Potensi Anak Anda',
      sub: 'Tuisyen berorientasikan keputusan dengan guru-guru berpengalaman',
      benefits: ['Guru bertauliah berpengalaman', 'Kelas bersaiz kecil', 'Silibus fokus peperiksaan', 'Laporan kemajuan berkala'],
    },
    zh: {
      headline: '发掘孩子的无限潜能',
      sub: '注重成绩的补习中心，经验丰富关爱学生的导师',
      benefits: ['经验丰富的合格导师', '小班制教学', '针对考试的课程', '定期进度报告'],
    },
  },
}
...
Return ONLY a valid JSON object (no markdown, no code fences):
{
  ...
  "servicesTitle": "Section title for services (e.g. 'Our Services')",
  "galleryTitle": "Section title for gallery (e.g. 'Our Gallery')",
  "resultsTitle": "Section title for before/after (e.g. 'Our Results')",
